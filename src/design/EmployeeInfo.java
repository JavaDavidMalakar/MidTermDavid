...
public class EmployeeInfo extends UnitTestingEmployeeInfo {
    ...
    public void describeCompany() {
        companyName = "Phoenix QA Solutions";

        System.out.println(" founded " + companyName + " on a warm June of 2010 which is located at " + locationOffice + ".");
    }
    ...
    public static double calculateEmployeeBonus(double salary, int performance) {
        ...
        if (performance == 5) {
            ...
            yearlyBonus = 0;
            System.out.println("Please work harder to get to a better stage in the company.");
        } else {
            yearlyBonus = 0;
            System.out.println("Your performance could be a reason for possible termination very soon.");
        }
        System.out.println("Congratulations, you deserve $" + yearlyBonus + " for all the hardwork you've done.");
        return yearlyBonus;
    }
    ...
    public static double calculateEmployeePension(double salary) {
        ...
        System.out.println("Total invested 401K amount is: $" + total);
